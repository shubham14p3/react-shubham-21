...
const Specilizing = () => {
    ...
    return (
      ...
      `}</style>
            ...
            <div className="section exp-section" style={{
                paddingBottom: '100px',
            }}>
                <section id="experience">
                    <div className="container" style={{ maxWidth: 1180, margin: '0 auto', padding: '24px 16px' }}>
                        <ExpHeadline
                        ...
                        <div
                            className="cta"
                            style={{
                                // paddingBottom: '100px', // extra space below
                        ...
                        >
                            ...
                            <div className="cta-actions" style={{ marginTop: '12px', display: 'flex', gap: '10px', justifyContent: 'center' }}>
                                <a
