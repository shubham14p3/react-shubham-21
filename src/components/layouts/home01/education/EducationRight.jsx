      ...
      skill: [
        {
          ...
          text:
            "Bachelor in Engineering with Computer Science Engineering from Bhilai Institute of Technology in year 2014-2018.",
        },
        {
          id: 2,
          ...
          title: "Intermediate",
          text:
            "Intermediate from Vidya Bharati Chinmaya Vidyalaya under C.B.S.E. in year 2014.",
        },
        {
          id: 3,
          ...
          title: "Matriculation",
          text:
            "Matriculation from Vidya Bharati Chinmaya Vidyalaya under C.B.S.E. in year 2011.",
        },
      ],
    };
  }
        ...
        >
          ...
          <div className="fl-btn btn-general btn-hv-border">
            ...
            <a
              ...
              className="-w500 lt-sp1 border-corner2 text-one"
            >
              Download Resume
            </a>
          </div>
